...
(defun chk-hidden-cases (folder assessment-questions assessment-tooling-file)
...
(defun chk-given-and-hidden-cases (assessment-data-file)
  (let* ((folder-raw "/tmp/CodeGrader")
         (folder (pathname (if (char= (char folder-raw (1- (length folder-raw))) #\/)
                                folder-raw
    ...
    (mapcar (lambda (q g h)
            ...
            (mapcar (lambda (res)
                    ...
                    (chk-given-cases folder assessment-questions assessment-data-file))
            (mapcar (lambda (res)
