...
1. *Create a zipped file containing the students' solutions*: Since
   ...
   Assume the parent folder *~/tmp/cps305PracticumTest/* contains the students' solutions from the various sections. Also assume you want to store that zip archive
