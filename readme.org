...
*NOTE*: By default, GEN-EXAM-FILES does not include the hidden test cases in the data file. To include the hidden test cases in the data file, call GEN-EXAM-FILES setting :INCLUDE-HIDDEN to T.
