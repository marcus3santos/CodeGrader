...
<doc-tag>        ::= "(" ":doc" <doc-props> <node-list> ")"
<doc-props>      ::= "(" ":title" <string> ":folder" <string> ")"

<node-list>      ::= <node> | <node> <node-list>
<node>           ::= <string> 
                   | <p-tag> | <ul-tag> | <ol-tag> | <li-tag> 
                   | <s-tag> | <q-tag>  | <cb-tag> | <wa-tag> 
                   | <tc-tag> | <gvn-tag> | <hdn-tag> | <a-tag> 
                   | <sols-tag> | <sol-tag>
...
<s-tag>          ::= "(" ":s" <s-props> <node-list> ")"
<s-props>        ::= "(" [ ":level" <integer> ] [ ":title" <string> ] ")"

<q-tag>          ::= "(" ":q" <q-props> <node-list> ")"
<q-props>        ::= "(" ":title" <string> ":number" <integer> 
                         [ ":forbidden" <list> ":penalty" <number> ] ")"

<cb-tag>         ::= "(" ":cb" <cb-props> <node-list> ")"
<cb-props>       ::= "(" ":language" <string> ")"

<wa-tag>         ::= "(" ":wa" <node-list> ")"
<tc-tag>         ::= "(" ":tc" <tc-props> <node-list> ")"
<tc-props>       ::= "(" ":function" <symbol> ")"

<gvn-tag>        ::= "(" ":gvn" <node-list> ")"
<hdn-tag>        ::= "(" ":hdn" <node-list> ")"
<sols-tag>       ::= "(" ":sols" <node-list> ")"
<sol-tag>        ::= "(" ":sol" <lisp-code-list> ")"

<a-tag>          ::= "(" ":a" <lisp-expression> <lisp-expression> ")"
