...
- The IT staff has created a zip archive file containing the students' solutions stored on the Linux machines. Here is the command the IT staff used to create that zip file:
  #+begin_src shell
