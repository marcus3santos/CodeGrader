...
assume the latter. In this case, the IT Technicians have provided you
with access to the solutions for each student of a given course
section, stored in in specific folders named
