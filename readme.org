...
SXM grammar:
#+begin_example
<sxm-expression> ::= <doc-tag>

<doc-node>        ::= "(" ":doc" <doc-props> <node-list> ")"
<doc-props>      ::= "(" ":title" <string> ":folder" <string> ")"

<node-list>      ::= <node> | <node> <node-list>
<node>           ::= <string> 
                   | <p-node> | <ul-node> | <ol-node> | <li-node> 
                   | <s-node> | <q-node>  | <cb-node> | <wa-node> 
                   | <tc-node> | <gvn-node> | <hdn-node> | <a-node> 
                   | <sols-node> | <sol-node>

<p-node>          ::= "(" ":p" <node-list> ")"
<ul-node>         ::= "(" ":ul" <node-list> ")"
<ol-node>         ::= "(" ":ol" <node-list> ")"
<li-node>         ::= "(" ":li" <node-list> ")"

<s-node>          ::= "(" ":s" <s-props> <node-list> ")"
<s-props>        ::= "(" [ ":level" <integer> ] [ ":title" <string> ] ")"

<q-node>          ::= "(" ":q" <q-props> <node-list> ")"
<q-props>        ::= "(" [ ":title" <string> ]
                         [ ":forbidden" <list> ":penalty" <number> ] ")"

<cb-node>         ::= "(" ":cb" <cb-props> <node-list> ")"
<cb-props>       ::= "(" ":language" <string> ")"

<wa-node>         ::= "(" ":wa" <node-list> ")"
<tc-node>         ::= "(" ":tc" <tc-props> <node-list> ")"
<tc-props>       ::= "(" ":function" <symbol> ")"

<gvn-node>        ::= "(" ":gvn" <node-list> ")"
<hdn-node>        ::= "(" ":hdn" <node-list> ")"
<sols-node>       ::= "(" ":sols" <node-list> ")"
<sol-node>        ::= "(" ":sol" <lisp-code-list> ")"
