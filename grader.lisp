...
(defun test ()
  (evaluate-solution "~/quicklisp/local-projects/codegrader/solution.lisp"  '(apr 7 1000 pm) '(apr 6 10000 pm) "~/quicklisp/local-projects/codegrader/lab04-unit-tests.lisp"  nil))

(defun test1 ()
  (evaluate-solution "~/quicklisp/local-projects/codegrader/std-code.lisp" '(apr 7 1000 pm) '(apr 6 10000 pm) "~/quicklisp/local-projects/codegrader/test-case1.lisp" nil))

(defun test2 ()
  (evaluate-solution "~/quicklisp/local-projects/codegrader/s1.lisp" '(apr 7 1000 pm) '(apr 6 10000 pm) "~/quicklisp/local-projects/codegrader/tc1.lisp" nil))

(defun test3 ()
  (evaluate-solution "~/quicklisp/local-projects/codegrader/s3.lisp" '(apr 7 1000 pm) '(apr 6 10000 pm) "~/quicklisp/local-projects/codegrader/tc3.lisp" nil))
